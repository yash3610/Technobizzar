            ...
            {showNewCategory ? (
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-3 py-2 bg-primary hover:bg-secondary text-background rounded-lg transition-colors text-sm"
                >
                  Add
                </button>
                <button
                  ...
                  className="px-3 py-2 bg-background hover:bg-surface text-text-primary border border-border-dark rounded-lg transition-colors text-sm"
                >
                  Cancel
                </button>
              </div>
